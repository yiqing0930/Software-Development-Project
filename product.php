...
<body>
    ...
    <div class="row">
        ...
        <div style="margin-left: 10px;">
            ...
            <br/>
            <div style="margin-left: 10px; background-color: #f0f0f0; border-radius: 10px;">
                <form action="sort_items.php" method="GET" style="margin-left: 5px; padding: 15px;">
                <h5>Sort Items By: </h5>

                <input type="radio" id="price_lowest" name="sortBy" value="price_lowest">
                <label for="price_lowest">Price (Lowest - Highest)</label><br>
                <input type="radio" id="price_highest" name="sortBy" value="price_highest">
                <label for="price_highest">Price (Highest - Lowest)</label><br>
               <input type="radio" id="a-z" name="sortBy" value="a-z">
                <label for="a-z">Alphabet (A-Z)</label><br>
                <input type="radio" id="z-a" name="sortBy" value="z-a">
                <label for="z-a">Alphabet (Z-A)</label><br>
                <br>
                <input type="submit" value="Apply Filters">
                </form>
            </div>
        ...
        <script>
            function toggleWishlist(button, itemID) {
                ...
                // Call a function to add/remove the item from the wishlist
            ...
            function addToWishlist(itemID) {
                ...
                sendWishlistDataToServer();
            }

            function sendWishlistDataToServer() {
                var itemIDs = Object.keys(localStorage);
                $.ajax({
                    type: 'POST',
                    url: 'wishlist_handler.php',
                    data: { itemIDs: itemIDs },
                    success: function(response) {
                        console.log('Wishlist data sent to server successfully.');
                    },
                    error: function(xhr, status, error) {
                        console.error('Error sending wishlist data to server:', error);
                    }
                });
            }
